...
async function GET() {
    ...
    try {
        const [users, subscribers] = await Promise.all([
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].newsletterSubscriber.findMany({
                where: {
                    active: true
                },
                orderBy: {
        ...
        const usersWithStats = await Promise.all(users.map(async (user)=>{
            const bookingCount = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].booking.count({
                where: {
                    email: user.email
                }
            });
        ...
        const subscribersList = subscribers.filter((s)=>!registeredEmails.has(s.email)).map((s)=>({
                id: s.id,
                name: null,
                email: s.email,
                role: 'USER',
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(allCustomers);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e14fcb0d._.js.map