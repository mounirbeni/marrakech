...
async function GET(request, { params }) {
    try {
        ...
        const booking = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].booking.findUnique({
            where: {
                id: params.id
            },
            include: {
...
async function PATCH(request, { params }) {
    try {
        ...
        if (body.status === 'CANCELLED') {
            const updatedBooking = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].booking.update({
                where: {
                    id: params.id
                },
                data: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4b8cf73b._.js.map