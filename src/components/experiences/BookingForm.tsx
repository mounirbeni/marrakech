                ...
                <div className="space-y-4 animate-in fade-in slide-in-from-bottom-4 duration-500 delay-200">
                    ...
                    <div className="grid gap-3">
                        <div className="relative">
                            ...
                            <Input className="pl-10 h-11 bg-background/80 border-input/60 focus:bg-background transition-colors" placeholder="Full Name" value={name} onChange={e => setName(e.target.value)} />
                        </div>
                        <div className="relative">
                            <Mail className="absolute left-3 top-3.5 h-4 w-4 text-muted-foreground z-10" />
                            <Input className="pl-10 h-11 bg-background/80 border-input/60 focus:bg-background transition-colors" type="email" placeholder="Email Address" value={email} onChange={e => setEmail(e.target.value)} />
                        </div>
                        <div className="relative">
                            <Phone className="absolute left-3 top-3.5 h-4 w-4 text-muted-foreground z-10" />
                            <Input className="pl-10 h-11 bg-background/80 border-input/60 focus:bg-background transition-colors" type="tel" placeholder="WhatsApp Number (e.g. +44...)" value={phone} onChange={e => setPhone(e.target.value)} />
                        </div>
