...
function BookingsPage() {
    ...
    const { data: bookings, error, isLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swr$2f$dist$2f$index$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"])(`/api/bookings?status=${statusFilter}`, fetcher);
    const handleStatusUpdate = async (id, newStatus)=>{
        try {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swr$2f$dist$2f$_internal$2f$config$2d$context$2d$client$2d$BoS53ST9$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__j__as__mutate$3e$__["mutate"])(`/api/bookings?status=${statusFilter}`);
        } catch (error) {
    ...
    // Client-side filtering for search (for now, ideally backend)
    const filteredBookings = bookings?.filter((booking)=>{
        if (!searchQuery) return true;
        const query = searchQuery.toLowerCase();
        return booking.name.toLowerCase().includes(query) || booking.email.toLowerCase().includes(query) || booking.activityTitle.toLowerCase().includes(query);
    });
...
_s(BookingsPage, "WfTY8gqLsbDRxQ5457u/+8Pw5YA=", false, function() {
    return [
...
//# sourceMappingURL=src_96b33bb8._.js.map